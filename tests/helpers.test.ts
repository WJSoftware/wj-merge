...
import { isArray, isSourceObject, isFunction, forEachProperty, attemptParse  } from '../src/helpers.js'; 
...
describe('helpers', () => {
    ...
    describe('isObject', () => {
        const testFn = (testObj: unknown, expectedResult: boolean) => {
            // Act.
            const result = isSourceObject(testObj);
    ...
    describe('attemptParse', () => {
        ...
        const stringTestFn = (value: string) => {
            // Act.
            const result = attemptParse(value);
